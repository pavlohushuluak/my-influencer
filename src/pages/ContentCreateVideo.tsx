...
function ContentCreateVideo({ influencerData }: ContentCreateVideoProps) {
  ...
  // Handle URL query parameters for automatic section and influencer selection
  React.useEffect(() => {
    const section = searchParams.get("section");
    const influencerId = searchParams.get("influencer");

    // Auto-select section if specified in URL
    if (section === "influencer" && !selectedOption) {
      setSelectedOption("image");
      console.log(
        'Automatically selected "Create Influencer Video" section from URL'
      );
    }

    // Log influencer selection for debugging
    if (influencerId) {
  ...
  return (
    <div>
      ...
      <div className="flex">
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto p-6">
          {/* Create Influencer Video Card */}
          <Card
            className="group relative overflow-hidden bg-gradient-to-br from-white via-blue-50/30 to-indigo-50/30 dark:from-slate-800 dark:via-blue-900/20 dark:to-indigo-900/20 border-0 shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-[1.02] cursor-pointer"
          ...
          >
            ...
            <CardHeader className="relative z-10 pb-4">
              ...
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                Generate stunning AI-powered videos with advanced customization
                options, scene settings, and character consistency
              </p>
            </CardHeader>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4 text-sm text-slate-600 dark:text-slate-300 group-hover:text-slate-700 dark:group-hover:text-slate-200 transition-colors duration-300">
                    <div className="w-3 h-3 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full shadow-sm"></div>
                    <span className="font-medium">
                      Multiple video formats and durations
                    </span>
                  </div>
                  <div className="flex items-center gap-4 text-sm text-slate-600 dark:text-slate-300 group-hover:text-slate-700 dark:group-hover:text-slate-200 transition-colors duration-300">
                    <div className="w-3 h-3 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full shadow-sm"></div>
          ...
          <Card
            className="group relative overflow-hidden bg-gradient-to-br from-white via-purple-50/30 to-pink-50/30 dark:from-slate-800 dark:via-purple-900/20 dark:to-pink-900/20 border-0 shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-[1.02] cursor-pointer"
          ...
          >
            ...
            <CardHeader className="relative z-10 pb-4">
              ...
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                Create engaging lip-sync videos with custom audio, voice
                selection, and synchronized mouth movements
              </p>
            </CardHeader>
            <CardContent className="relative z-10 pt-0">
              <div className="space-y-6">
