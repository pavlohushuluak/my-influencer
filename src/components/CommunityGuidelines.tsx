...
export function CommunityGuidelines({
  ...
  const handlePrint = () => {
    ...
    const elementsToRemove = printContent.querySelectorAll(
      ".modal-close, .print-button, [data-modal]"
    );
          ...
          <div id="community-guidelines-content" className="p-6 space-y-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-purple-800 dark:text-purple-200">
                    These Community Guidelines and Acceptable Use Policy
                    establish the standards of conduct for all users of the
                    Nymia.ai platform.
                  </p>
                </div>
              </div>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4 flex items-center gap-2">
                <span className="bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold">
                  1
                </span>
                Introduction
              </h2>
              <div className="bg-gray-50 dark:bg-gray-900/30 rounded-lg p-4">
                <p className="text-gray-700 dark:text-gray-300">
                  These Community Guidelines and Acceptable Use Policy
                  ("Guidelines") establish the standards of conduct for all
                  users of the Nymia.ai platform (the "Service"). Our mission is
                  to provide a safe, creative, and respectful environment where
                  users can create virtual influencers and digital characters
                  using AI technology.
                </p>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-800 dark:text-red-200">
                      <strong>
                        BY USING THE SERVICE, YOU AGREE TO COMPLY WITH THESE
                        GUIDELINES. VIOLATION OF THESE GUIDELINES MAY RESULT IN
                        CONTENT REMOVAL, ACCOUNT SUSPENSION, OR PERMANENT
                        TERMINATION.
                      </strong>
                    </p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-800 dark:text-green-200">
                        We are committed to maintaining a platform that
                        prioritizes user safety, respects human dignity, and
                        fosters creative expression within legal and ethical
                        boundaries.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-800 dark:text-blue-200">
                        All content and activities on our platform must comply
                        with applicable local, state, federal, and international
                        laws.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-purple-50 dark:bg-purple-950/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-purple-800 dark:text-purple-200">
                        Users must respect the rights and privacy of real
                        individuals and obtain proper consent when creating
                        content that may affect others.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-800 dark:text-yellow-200">
                        We support creative expression and artistic freedom
                        while maintaining appropriate boundaries to protect our
                        community.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-red-800 dark:text-red-200 space-y-1 ml-4">
                        ...
                        <li>
                          • Facilitates fraud, scams, or deceptive practices
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-orange-800 dark:text-orange-200 mb-3">
                        The following types of harmful content are strictly
                        prohibited:
                      </p>
                      <div className="space-y-3">
                        <div>
                          ...
                          <ul className="text-sm text-orange-800 dark:text-orange-200 space-y-1 ml-4">
                            <li>
                              • Content depicting graphic violence, torture, or
                              cruelty
                            </li>
                            <li>
                              • Threats of violence against individuals or
                              groups
                            </li>
                        ...
                        <div>
                          ...
                          <ul className="text-sm text-orange-800 dark:text-orange-200 space-y-1 ml-4">
                            ...
                            <li>
                              • Content designed to humiliate or degrade others
                            </li>
                          </ul>
                        </div>
                        <div>
                          ...
                          <ul className="text-sm text-orange-800 dark:text-orange-200 space-y-1 ml-4">
                            <li>
                              • Content promoting hatred based on race,
                            ...
                            <li>
                              • Content inciting violence against protected
                              groups
                            </li>
                          </ul>
                        </div>
                ...
                <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-red-800 dark:text-red-200 space-y-1 ml-4">
                        <li>
                          • Any content involving minors in sexual or suggestive
                          contexts
                        </li>
                        <li>
                          • Content depicting or promoting human trafficking
                        </li>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-yellow-800 dark:text-yellow-200 space-y-1 ml-4">
                        <li>
                          • Create content impersonating real individuals
                          without consent
                        </li>
                        <li>
                          • Use another person's likeness, name, or identity
                          without permission
                        </li>
                        <li>
                          • Create deepfakes of real people without explicit
                          consent
                        </li>
                        <li>• Misrepresent your identity or credentials</li>
                        <li>
                          • Create content designed to deceive or mislead others
                          about real events
                        </li>
                      </ul>
                    </div>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-800 dark:text-blue-200">
                        The Service permits the creation of adult content,
                        including nudity and sexual content, subject to strict
                        guidelines and age verification requirements.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-yellow-800 dark:text-yellow-200 space-y-1 ml-4">
                        <li>
                          • All users accessing adult content features must be
                          18 years or older
                        </li>
                        <li>
                          • Age verification may be required through third-party
                          services
                        </li>
                        <li>
                          • Users under 18 are prohibited from creating or
                ...
                <div className="bg-gray-50 dark:bg-gray-900/30 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">
                    Virtual Character Requirements
                  </h3>
                  <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
                  ...
                  <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-1 ml-4">
                    ...
                    <li>
                      • Not resemble real individuals without explicit consent
                    </li>
                ...
                <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-red-800 dark:text-red-200 space-y-1 ml-4">
                        <li>
                          • Content depicting or suggesting minors in sexual
                          contexts
                        </li>
                        ...
                        <li>
                          • Content violating applicable obscenity standards
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-800 dark:text-green-200 mb-3">
                        Users must use AI generation tools responsibly and
                        ethically:
                      </p>
                      <ul className="text-sm text-green-800 dark:text-green-200 space-y-1 ml-4">
                        <li>
                          • Do not attempt to create content depicting real
                          individuals without consent
                        </li>
                        <li>
                          • Avoid prompts designed to generate illegal or
                          harmful content
                        </li>
                        <li>
                          • Respect the limitations and guidelines of AI
                          providers
                        </li>
                        <li>
                          • Do not attempt to circumvent content filters or
                          safety measures
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-800 dark:text-blue-200 mb-3">
                        Special requirements for AI-generated content depicting
                        people:
                      </p>
                      <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1 ml-4">
                        <li>
                          • Must not depict real, identifiable individuals
                          without explicit written consent
                        </li>
                        <li>
                          • Must be clearly labeled as AI-generated when shared
                          outside the platform
                        </li>
                        <li>
                          • Must not be used to create false or misleading
                          information about real people
                        </li>
                        <li>
                          • Must not be used for harassment, blackmail, or other
                          harmful purposes
                        </li>
                      </ul>
                    </div>
                ...
                <div className="bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-yellow-800 dark:text-yellow-200 space-y-1 ml-4">
                        <li>
                          • Do not use copyrighted images as input without
                          permission
                        </li>
                        <li>
                          • Avoid creating content that substantially reproduces
                          copyrighted works
                        </li>
                        <li>• Respect trademark rights and brand identities</li>
                        <li>
                          • Do not create content infringing on others'
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-purple-800 dark:text-purple-200 space-y-1 ml-4">
                        <li>
                          • Obtain explicit consent before creating content
                        ...
                        <li>
                          • Do not create content using private or personal
                          information without consent
                        </li>
                        <li>
                          • Honor requests to remove content depicting someone
                          without permission
                        </li>
                      </ul>
                    </div>
                ...
                <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-red-800 dark:text-red-200 space-y-1 ml-4">
                        <li>
                          • Attempt to hack, exploit, or compromise the Service
                        </li>
                        <li>
                          • Use automated tools to access or interact with the
                          Service
                        </li>
                        <li>
                ...
                <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-green-800 dark:text-green-200 space-y-1 ml-4">
                        <li>
                          • Use the Service in accordance with intended purposes
                        </li>
                        <li>• Not abuse free trials or promotional offers</li>
                        <li>• Respect usage limits and restrictions</li>
                        <li>
                          • Not attempt to circumvent payment or subscription
                          requirements
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1 ml-4">
                        ...
                        <li>
                          • Automatically remove clearly violating content
                        </li>
                ...
                <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-green-800 dark:text-green-200 space-y-1 ml-4">
                        <li>
                          • Submitting an appeal through their account dashboard
                        </li>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-900/30 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-1 ml-4">
                    ...
                    <li>
                      • Location of the violating content (URL, username, etc.)
                    </li>
                ...
                <div className="bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-800 dark:text-yellow-200 mb-3">
                        Our enforcement approach typically follows this
                        progression:
                      </p>
                      <ul className="text-sm text-yellow-800 dark:text-yellow-200 space-y-1 ml-4">
                        <li>
                          • <strong>First Violation:</strong> Warning and
                          content removal
                        </li>
                        <li>
                          • <strong>Second Violation:</strong> Temporary account
                          suspension (1-7 days)
                        </li>
                        <li>
                          • <strong>Third Violation:</strong> Extended
                          suspension (7-30 days)
                        </li>
                        <li>
                          • <strong>Continued Violations:</strong> Permanent
                          account termination
                        </li>
                      </ul>
                    </div>
                ...
                <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-800 dark:text-red-200 mb-3">
                        Certain violations may result in immediate permanent
                        termination:
                      </p>
                      <ul className="text-sm text-red-800 dark:text-red-200 space-y-1 ml-4">
                        <li>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-green-800 dark:text-green-200 space-y-1 ml-4">
                        ...
                        <li>
                          • The user demonstrates understanding of guidelines
                        </li>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-800 dark:text-blue-200 mb-3">
                        We recognize cultural differences in content standards
                        and strive to:
                      </p>
                      <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1 ml-4">
                        <li>
                          • Apply guidelines consistently across all users
                        </li>
                        <li>
                          • Consider cultural context in moderation decisions
                        </li>
                        <li>
                          • Provide clear explanations for enforcement actions
                        </li>
                        <li>
                          • Maintain dialogue with diverse user communities
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-purple-800 dark:text-purple-200 mb-3">
                        We support artistic and creative expression while
                        maintaining safety:
                      </p>
                      <ul className="text-sm text-purple-800 dark:text-purple-200 space-y-1 ml-4">
                        <li>
                          • Artistic nudity may be permitted with appropriate
                          labeling
                        </li>
                        <li>• Creative content is evaluated in context</li>
                        <li>
                          • Educational content receives special consideration
                        </li>
                        <li>
                          • Parody and satire are generally permitted within
                          bounds
                        </li>
                      </ul>
                    </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-900/30 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-1 ml-4">
                    <li>
                      • Must be factually accurate when presenting as news
                    </li>
                    <li>
                      • Should be clearly labeled as opinion when appropriate
                    </li>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-yellow-800 dark:text-yellow-200 space-y-1 ml-4">
                        ...
                        <li>
                          • Seek clarification when guidelines are unclear
                        </li>
                ...
                <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-800 dark:text-green-200 mb-3">
                        We provide resources to help users understand and comply
                ...
                <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-800 dark:text-green-200">
                        <strong>Email:</strong> contact@sayasaas.com
                        <br />
                        <strong>Subject:</strong> "Community Guidelines
                        Question"
                      </p>
                    </div>
                  </div>
              ...
              <div className="space-y-4">
                <div className="bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-800 dark:text-yellow-200 mb-3">
                        We reserve the right to enforce these guidelines at our
                        discretion and may consider factors such as:
                      </p>
                      <ul className="text-sm text-yellow-800 dark:text-yellow-200 space-y-1 ml-4">
                ...
                <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-800 dark:text-red-200">
                        These guidelines do not guarantee that all content on
                        the platform will comply with your personal standards or
                        preferences.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-900/30 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-700 dark:text-gray-300">
                    These guidelines do not limit our legal rights or remedies
                    under applicable law or our Terms of Service.
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
              <div className="text-center text-sm text-gray-600 dark:text-gray-400">
                ...
                <p className="mt-2 text-xs">
                  <strong>Remember:</strong> When in doubt, err on the side of
                  caution. If you're unsure whether content complies with these
                  guidelines, contact our support team before posting.
                </p>
              </div>
            </div>
          </div>
