...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Editor", url: "/create/edit", icon: Edit },
      // { title: "Compose", url: "/create/compose", icon: Palette },
      { title: "Composer", url: "/create/composer", icon: Sparkles },
      {
        title: "Face Swap",
        url: "/create/faceswap",
        icon: RefreshCw,
...
export function AppSidebar() {
  ...
  return (
    <Sidebar
      collapsible="icon"
      variant="inset"
      className="border-r border-border/40 bg-gradient-to-b from-background via-background/98 to-background/95 p-0"
    >
      <SidebarHeader
                        ...
                        >
                          <div
                            className={`${
                              isCollapsed
                                ? ""
                                : "w-8 h-8 rounded-lg bg-gradient-to-br from-purple-100 to-blue-100 dark:from-purple-900/50 dark:to-blue-900/50 group-hover:scale-105 transition-transform"
                            } flex items-center justify-center`}
                          >
                                ...
                                <div
                                  ...
                                  className={cn(
                                    ...
                                    location.pathname === subItem.url &&
                                      "bg-gradient-to-r from-purple-100 to-blue-100 dark:from-purple-900/60 dark:to-blue-900/60 text-purple-700 dark:text-purple-300 font-medium shadow-sm border border-purple-200/50 dark:border-purple-800/30"
                                  )}
                                >
                                  {subItem.icon && (
                    ...
                    <SidebarMenuButton
                      ...
                      className={cn(
                        ...
                        (item.isActive
                          ? item.isActive(location.pathname)
                          : location.pathname === item.url) &&
                          "bg-gradient-to-r from-purple-100 to-blue-100 dark:from-purple-900/60 dark:to-blue-900/60 text-purple-700 dark:text-purple-300 font-medium shadow-lg border border-purple-200/50 dark:border-purple-800/30"
                      )}
                      tooltip={isCollapsed ? item.title : undefined}
                    >
                      <div
                        ...
                        } from-purple-100 to-blue-100 dark:from-purple-900/50 dark:to-blue-900/50 group-hover:scale-105 transition-transform flex items-center justify-center`}
                      >
                        <item.icon className="w-4 h-4 text-purple-600 dark:text-purple-400" />
                      </div>
                      {!isCollapsed && (
      ...
      <SidebarFooter className="border-t border-border/30 bg-gradient-to-r from-purple-50/30 to-blue-50/30 dark:from-purple-950/20 dark:to-blue-950/20 p-2 px-4">
        ...
        <div
          ...
          className={`${
            isCollapsed
              ? "flex items-center gap-2 cursor-pointer hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 dark:hover:from-purple-950/40 dark:hover:to-blue-950/40 transition-all duration-300 rounded-lg py-3"
              : "flex items-center gap-2 cursor-pointer hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 dark:hover:from-purple-950/40 dark:hover:to-blue-950/40 transition-all duration-300 rounded-lg py-3 px-3"
          }`}
        >
