...
export function AgeVerification({
  ...
  const [adultContentAcknowledged, setAdultContentAcknowledged] =
    useState(false);
  ...
  const validateForm = () => {
    ...
    if (!adultContentAcknowledged) {
      newErrors.adultContentAcknowledged =
        "You must acknowledge the adult content policy";
    }
        ...
        <CardContent className="space-y-6">
          <Alert className="border-orange-200/50 bg-orange-50/50 dark:border-orange-200/20 dark:bg-orange-950/20">
            ...
            <AlertDescription className="text-orange-800 dark:text-orange-200">
              <strong>Important:</strong> This platform may contain adult
              content and requires age verification for legal compliance.
            </AlertDescription>
          </Alert>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={cn(
                    ...
                    isAgeValid &&
                      "border-green-500 dark:border-green-400 focus:border-green-500 dark:focus:border-green-400 focus:ring-green-500 dark:focus:ring-green-400"
                  )}
                  required
                />
              </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                >
                  I confirm that I am at least 18 years of age and legally able
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setAdultContentAcknowledged(checked as boolean)
                  }
                  className="mt-0.5"
                />
                <Label
                  ...
                  className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed cursor-pointer"
                >
                  I understand that this platform may contain adult content and
                  I consent to viewing such material.
                </Label>
              </div>
