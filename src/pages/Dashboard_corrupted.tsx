...
import { Plus, Settings, MoreHorizontal, Image, Copy, Upload, X, Loader2, Sparkles, FileVideo, Palette, RefreshCw, Zap, CheckCircle, Brain, FolderOpen, Volume2, Edit, FileText, Camera, Video, Trash2 } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const handleManageBio = (id: string) => {
    ...
    if (influencer) {
      toast.info(`Managing bio for ${influencer.name_first} ${influencer.name_last}`);
      // TODO: Navigate to bio management page
    }
  };
  ...
  const handleCreateImage = (id: string) => {
    const influencer = influencers.find(inf => inf.id === id);
    if (influencer) {
      navigate("/create/image", { state: { influencerData: influencer } });
    }
  };
  ...
  const handleCreateVideo = (id: string) => {
    const influencer = influencers.find(inf => inf.id === id);
    if (influencer) {
      toast.info(`Creating video for ${influencer.name_first} ${influencer.name_last}`);
  ...
  const handleDeleteInfluencer = (id: string) => {
    const influencer = influencers.find(inf => inf.id === id);
    if (influencer) {
      const confirmed = window.confirm(`Are you sure you want to delete ${influencer.name_first} ${influencer.name_last}? This action cannot be undone.`);
      if (confirmed) {
        toast.error(`Deleting ${influencer.name_first} ${influencer.name_last}`);
  ...
  return (
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                    ...
                    <div>
                      ...
                      <div className="flex flex-col gap-1 mb-3">
                        ...
                        <Button
                          ...
                          className="w-full bg-gradient-to-r from-red-50 to-rose-50 dark:from-red-900/20 dark:to-rose-900/20 border-red-200 dark:border-red-700 hover:from-red-100 hover:to-rose-100 dark:hover:from-red-800/30 dark:hover:to-rose-800/30 text-red-700 dark:text-red-300 font-medium shadow-sm hover:shadow-md transition-all duration-200"
      ...
      {/* Phase 3 - Create Content Container */}
      <Card>
                <CardHeader className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 border-b border-purple-200/50 dark:border-purple-800/50 p-3 sm:px-6 lg:px-10 mb-4 sm:mb-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
            <CardTitle className="text-lg sm:text-xl font-semibold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Phase 3 - Create Content</CardTitle>
            <Button 
              variant="ghost" 
              size="sm" 
              className="text-purple-600 hover:text-purple-700 hover:bg-purple-100 dark:hover:bg-purple-900/30 text-sm px-3 sm:px-4 py-2" 
                        ...
                        <div>
                          ...
                          <div className="flex flex-col gap-1 mb-3">
                            ...
                            <Button
                              ...
                              className="flex-1 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-xs sm:text-sm px-2 sm:px-3 py-2"
                            >
      ...
      {/* Phase 4 - Organize Library Container */}
      <Card>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
            <CardTitle className="text-lg sm:text-xl font-semibold bg-gradient-to-r from-orange-600 to-amber-600 bg-clip-text text-transparent">Phase 4 - Organize Your Library</CardTitle>
            <Button 
              variant="ghost" 
              size="sm" 
                        ...
                        <div>
                          ...
                          <div className="flex flex-col gap-1 mb-3">
                            ...
                            <Button
                              size="sm"
                              variant="outline"
                              onClick={() => setShowPhase4LibraryModal(true)}
